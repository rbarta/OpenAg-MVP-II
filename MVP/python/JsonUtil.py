# Author: Howard Webb
# Date: 3/5/2018
# Create JSON structure for saving data and push to CouchDB
...
def makeEnvJson(activity_type, subject, subject_location, attribute, value, participant, status_qualifier, timestamp=None, status='Complete', status_qualifier_reason='', comment='', validate=False):
...
def makePhenoJson(activity_type, plot_id, subject, attribute, value, participant, status_qualifier, timestamp=None, status='Complete', status_qualifier_reason='', comment='', validate=False):
...
def validateEnvironObsv(subject, field_location, attribute, value, participant, status, status_qualifier):
...
def validatePhenoObsv(plot_id, subject, attribute, value, participant, status, status_qualifier):
    valid=True
    reason=''
